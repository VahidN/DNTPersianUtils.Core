...
namespace DNTPersianUtils.Core
{
    ...
    public static class PersianDateTimeUtils
    {
        ...
        {
            return ToPersianDate(persianYear, persianMonth, persianDay).ToDateOnly();
        }
#endif
        ...
        /// <param name="beginningOfCentury">سال شروع قرن، اگر سال وارد شده دو رقمی است</param>
        /// <returns>تاریخ و زمان میلادی</returns>
        public static DateOnly? ToGregorianDateOnly(this string? persianDateTime, bool convertToUtc = false, int beginningOfCentury = 1300)
        {
            return ToGregorianDateTime(persianDateTime, convertToUtc, beginningOfCentury).ToDateOnly();
        }
#endif
        ...
        {
            return date.ToDateTime().ToLongPersianDateString(convertToIranTimeZone);
        }
#endif
        ...
        {
            return date.ToDateTime().ToLongPersianDateTimeString(convertToIranTimeZone);
        }
#endif
        ...
        {
            return date.ToDateTime().ToPersianDateTimeString(format, convertToIranTimeZone);
        }
#endif
        ...
        {
            return gregorianDate.ToDateTime().ToPersianYearMonthDay(convertToIranTimeZone);
        }
#endif
        ...
        {
            return date.ToDateTime().ToShortPersianDateString(convertToIranTimeZone);
        }
#endif
        ...
        {
            return date.ToDateTime().ToShortPersianDateTimeString(convertToIranTimeZone);
        }
#endif
