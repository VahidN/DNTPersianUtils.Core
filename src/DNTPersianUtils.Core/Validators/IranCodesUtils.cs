...
public static class IranCodesUtils
{
    ...
    private static readonly Regex _matchIranianMobileNumber2 =
        new(@"^(9){1}[0-9]{9}$", RegexOptions.Compiled | RegexOptions.IgnoreCase, RegexUtils.MatchTimeout);

    private static readonly Regex _matchIranianPhoneNumber =
        new("^[2-9][0-9]{7}$", RegexOptions.Compiled | RegexOptions.IgnoreCase, RegexUtils.MatchTimeout);
